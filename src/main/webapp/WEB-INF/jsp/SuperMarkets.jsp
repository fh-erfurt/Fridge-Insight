    ...
    <table class="table">
        ...
        <c:forEach var="superMarket" items="${SuperMarkets}">
            ...
            <tr>
                ...
                <td><a href="${delete}" onclick="if (!(confirm('Are you sure you want to delete this SuperMarket?'))) return false"><img alt="delete image" style="width: 40px; height: 40px;"src="resources/images/delete.png"/></a></td>
