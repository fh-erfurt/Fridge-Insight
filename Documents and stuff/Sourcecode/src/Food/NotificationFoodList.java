...
/**
 * the class Food.NotificationFoodList is used to create a new list for the notifications</br>
...
public class NotificationFoodList {
    ...
    /**
     * the constructor for the class Food.NotificationFoodList, where a new list will be initialised
     */
     ...
     *
     * @return list of type Food.NotificationFood
     */
     ...
     *
     * @param notifications the received list of notifications
     */
     ...
     */
    public void addNotificationToList(NotificationFood notificationFood) {
     ...
     */
    public void deleteNotificationFromList(NotificationFood notificationFood) {
