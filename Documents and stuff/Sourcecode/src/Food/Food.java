...
/**
 * the class Food.Food is used to create an item of food</br>
...
public class Food {
    ...
    /**
     * the constructor of the class Food.Food, where all the varibales are set to null.
     */
    public Food() {
        this.foodTitle = null;
    ...
    /**
     * the overloaded constructor of the class Food.Food, where each variable is set to a certain value.
     *
