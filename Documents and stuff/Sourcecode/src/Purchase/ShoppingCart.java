...
public class ShoppingCart {
    ...
    /**
     * the constructor of the class Purchase.ShoppingCart, where an new list will be initialised.
     */
    public ShoppingCart() {
     ...
     */
    public void addPurchaseListToCart(PurchaseList purchaseList) {
     ...
     */
    public void deletePurchaseListFromCart(PurchaseList purchaseList) {
