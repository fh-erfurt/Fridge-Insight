...
/**
 * the class User.Account extends the class User.Person</br>
...
public class Account extends Person {
    ...
    /**
     * the Constructor of the class User.Account, where all the variables are set to null.</br>
     * this constructor calls automatically the constructor of the parent class User.Person.</br>
     */
    public Account() {
    ...
    /**
     * the overloaded constructor of the class User.Account, where each variable is set to a specific value.</br>
