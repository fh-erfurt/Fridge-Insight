...
/**
 * the class User.UserList is used to make a new list containing all the Accounts</br>
 * in this class we can manage (delete, add, modify) each User.Account individually</br>
 *
 * @author Hamza Harti
 * @version 1.0
 * @see Person
...
public class UserList {
    ...
    /**
     * the constructor of the class User.UserList, where an new list will be initialised.
     */
    public UserList() {
     ...
     *
     * @return list of type User.Account
     */
     ...
     */
    public int indexOfElement(Account user) {
     ...
     */
    public void addUserToList(Account userX) {
     ...
     */
    public void deleteUserFromList(String firstName, String lastName, String Password) {
     ...
     * @param superUser the Superuser, who'll carry the operation
     */
    public void superUserDelete(String firstName, String lastName, Account superUser) {
        Account referenceAccount = new Account();
     ...
     */
    public void updateUser(String firstName, String lastName, int Age, float Height, String familyPosition, String Password, String newLastName, String newFirstName, String newPassword) {
