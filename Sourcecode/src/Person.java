/**
 * the class Person is used to contain all the necessary informations about a certain person</br>
 * it is an abstract class, which all of its attributes and methods will inherited by the class Account</br>
 *
 * @author Hamza Harti
 * @version 1.0
 * @see Account
