 ...
 * in addition to an address created with the help of the class Food.Address</br>
 *
 * @author Hamza Harti
 * @version 1.0
 * @see Address
...
public class SuperMarket {
    ...
    /**
     * the construtor of the class Food.SuperMarket, where all the variables are set to null.
     */
    public SuperMarket() {
    ...
    /**
     * the overloaded constructor of the class Food.SuperMarket, where each variabble is set to a certain variable.
     *
